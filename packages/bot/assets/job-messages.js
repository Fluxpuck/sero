const JOB_MESSAGES = {
    ...
    3: [
        ...
        `You successfully defended a client in court. ⚖️ You received {COIN} coins.`,
    ...
    4: [
        ...
        `You found an error in the financial statements that everyone else missed. Sherlock has nothing on you. 🕵️‍♂️ You received {COIN} coins.`,
    ...
    6: [
        ...
        `You taught a student how to write their name! ✍️ You received {COIN} coins.`,
    ...
    7: [
        ...
        `You caught a graffiti artist red-handed, or should I say, paint-handed. 🎨 You received {COIN} coins.`,
    ...
    11: [
        ...
        `You made a video on how to make a redstone contraption, featuring Zakaria. 🛠️ You received {COIN} coins.`,
    ...
    13: [
        ...
        `You performed a heart transplant, the patient is doing well! ❤️ You received {COIN} coins.`,
        ...
        `You and your assistant Seven procrastinate on some paperwork, but you still got paid {COIN} coins.`,
    ],
    14: [
        ...
        `You created a mural on a city wall. It's the talk of the town! 🏙️ You received {COIN} coins.`,
        `You painted a self-portrait. It was so realistic that your mirror got jealous. 🖼️ You received {COIN} coins.`,
    ...
    15: [
        `You worked as a chef and made a delicious meal for a customer! 🍽️ You received {COIN} coins.`,
    ...
    16: [
        `You did a loop-de-loop with the plane, the passengers weren't too happy about it. ✈️ You received {COIN} coins.`,
        `You flew a plane over the Bermuda Triangle, how'd you even end up over there? 🛩️ You received {COIN} coins and an interview for somehow surviving.`,
        ...
        `You had to fly through a storm, but you kept everyone safe. 🌩️ You received {COIN} coins.`,
    ...
    17: [
        ...
        `You cleared out the clogged toilet like a superhero in a porcelain cape. 🦸‍♂️ You got paid {COIN}.`,
    ...
    18: [
        ...
        `You get hit by lightning, that's unrelated to your job but it happened. 🌩️ You recieved {COIN} coins.`,
    ]
}
